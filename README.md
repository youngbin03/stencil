...
> 📊 **Full project report:** open [`docs/portfolio.html`](docs/portfolio.html) for the pipeline, AI-engineering decisions, hard problems solved, and the design-system inspector.
